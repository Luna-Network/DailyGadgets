...
@section('content')
    ...
    <div class="wrap cf">
        <h1 class="projTitle">My Orders</h1>
        <div class="cart">
                    ...
                    <li class="items even">
                        ...
                        <div class="infoWrap">
                            <div class="cartSection">
                                ...
                                <img src="{{ substr($items[$i]->images, 0, strpos($items[$i]->images, ';')) }}" alt="" class="itemImg" />
                                {{--                            <p class="itemNumber">#QUE-007544-002</p>--}}
                                <h3 style="margin-bottom: 20px">{{$items[$i]->title}}</h3>

                                <p> <strong>Qty: </strong>{{$orders[$i]->qty}}</p>
                                <br>
                                <br>

                                <p> <strong>Ordered at: </strong>{{$orders[$i]->created_at}}</p>
